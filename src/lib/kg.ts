...
export async function getSkills() {
  return [
    ...
    { name: 'naesengmoon', description: '나생문 (canonical, alias: taliban) — 적대적 검증, 9-lens constitutional' },
    { name: '88-naesengmoon', description: '113-lens mathematical meta-verification' },
